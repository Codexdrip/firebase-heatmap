...
var tl = new _gsap.TimelineMax({ repeat: -1, repeatDelay: 1, delay: 2.5 });
var tl2 = new _gsap.TimelineMax({ repeat: -1 });
// tl2
//   .to(ship, 10, {
//     bezier: {
//       curviness: 1.25,
...
tl.from(s, 0.3, { y: -100, opacity: 0 }).to(s, 0.3, { y: 100, opacity: 0 }).from(c, 0.3, { y: -100, opacity: 0 }).to(c, 0.3, { y: 100, opacity: 0 }).from(r, 0.3, { y: -100, opacity: 0 }).to(r, 0.3, { y: 100, opacity: 0 }).from(o, 0.3, { y: -100, opacity: 0 }).to(o, 0.3, { y: 100, opacity: 0 }).from(l1, 0.3, { y: -100, opacity: 0 }).to(l1, 0.3, { y: 100, opacity: 0 }).from(l2, 0.3, { y: -100, opacity: 0 }).to(l2, 0.3, { y: 100, opacity: 0 });
