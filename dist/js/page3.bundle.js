...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/scrollAnima.js");
/******/ })
/************************************************************************/
/******/ ({
...
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Major+Mono+Display&display=swap);", ""]);
// Module
exports.push([module.i, "* {\n  box-sizing: border-box;\n  transition: background-color .6s, box-shadow .6s, border-radius .6s, width .6s, transform .6s; }\n\n/* Optional: Makes the sample page fill the window. */\nhtml, body {\n  height: 100%;\n  width: 100%;\n  margin: 0;\n  overflow-x: hidden;\n  padding: 0;\n  background: #0e1626;\n  color: #ccc;\n  display: flex;\n  flex-direction: column;\n  font-family: \"Poppins\", sans-serif; }\n\n/* Modal start */\n/* The Modal (background) */\n.modal {\n  display: none;\n  /* Hidden by default */\n  position: fixed;\n  /* Stay in place */\n  z-index: 1;\n  /* Sit on top */\n  left: 0;\n  top: 0;\n  width: 100%;\n  /* Full width */\n  height: 100%;\n  /* Full height */\n  overflow: auto;\n  /* Enable scroll if needed */\n  background-color: black;\n  /* Fallback color */\n  background-color: rgba(0, 0, 0, 0.4);\n  /* Black w/ opacity */ }\n\n/* Modal Content/Box */\n.modal-content {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background-color: green;\n  margin: 15% auto;\n  /* 15% from the top and centered */\n  padding: 20px;\n  border: 1px solid #000;\n  width: 45%;\n  /* Could be more or less, depending on screen size */\n  border-radius: 10px; }\n  .modal-content .fa-exclamation-circle {\n    font-size: 32px;\n    font-weight: bold; }\n\n/* The Close Button */\n.close {\n  align-self: flex-end;\n  color: #aaa;\n  font-size: 28px;\n  font-weight: bold; }\n\n.close:hover,\n.close:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer; }\n\n/* Modal end*/\nh1 {\n  font-size: 32px;\n  font-weight: 700; }\n\nh3 {\n  font-size: 16px;\n  font-weight: 300; }\n\nsection {\n  width: 100%;\n  height: 80vh; }\n\n.fa-bell {\n  color: #0029FA; }\n\n.accent {\n  color: #F25CA2; }\n\n.sm-card {\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n  /* this adds the \"card\" effect */\n  padding: 0;\n  text-align: center;\n  background-color: #f1f1f1;\n  border-radius: 8px;\n  width: 50%;\n  height: 50%; }\n\n.card {\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n  /* this adds the \"card\" effect */\n  padding: 0;\n  text-align: center;\n  background-color: #f1f1f1;\n  border-radius: 8px;\n  width: 100%;\n  height: 80%; }\n\n.button {\n  width: 100%;\n  height: auto;\n  line-height: 50px;\n  border-radius: 50%;\n  background-color: #0029FA;\n  color: #FFFFFF;\n  font-size: 24px;\n  border: none;\n  box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.26), 0 2px 10px 0 rgba(0, 0, 0, 0.22);\n  cursor: pointer; }\n  .button:hover {\n    background: #6e90d3;\n    box-shadow: 0 5px 11px 0 rgba(0, 0, 0, 0.28), 0 4px 15px 0 rgba(0, 0, 0, 0.25); }\n  .button:active {\n    background: #6e90d3;\n    box-shadow: 0 5px 11px 0 rgba(0, 0, 0, 0.28), 0 4px 15px 0 rgba(0, 0, 0, 0.25); }\n\n.map {\n  flex: 5;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  padding: 0 16px;\n  /* Always set the map height explicitly to define the size of the div\n      * element that contains the map. */ }\n  .map .map-title {\n    flex: 0; }\n  .map .map-sub-title {\n    flex: 0; }\n  .map #map {\n    flex: 2 0 50vh;\n    width: 100%;\n    height: 100%; }\n\n.users {\n  flex: 1;\n  margin-bottom: 5vh;\n  color: #0e1626;\n  display: flex;\n  flex-direction: row;\n  padding: 0 16px;\n  align-items: flex-start; }\n  .users .user-checkin {\n    margin: 16px;\n    padding: 32px;\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    align-content: center;\n    justify-content: center; }\n    .users .user-checkin .checkin-text {\n      flex: 0;\n      width: 100%;\n      align-self: center; }\n    .users .user-checkin .users-checkin-btn {\n      flex: 1;\n      width: 20%;\n      perspective: 50px;\n      transform-style: preserve-3d;\n      transform-origin: center;\n      display: grid;\n      grid-template-columns: 1fr 3fr 1fr;\n      grid-template-rows: 100%; }\n      .users .user-checkin .users-checkin-btn .front {\n        justify-self: center;\n        grid-column: 2/3;\n        grid-row: 1;\n        z-index: 2;\n        /* for firefox 31 */\n        transform: rotateY(0deg);\n        transform-origin: center;\n        backface-visibility: hidden;\n        background-color: #230A59; }\n      .users .user-checkin .users-checkin-btn .back {\n        justify-self: center;\n        grid-column: 2/3;\n        grid-row: 1;\n        transform: rotateY(180deg);\n        transform-origin: center;\n        backface-visibility: hidden;\n        background-color: #F25CA2; }\n  .users .latest {\n    margin: 16px;\n    padding: 24px;\n    flex: 1;\n    display: flex;\n    flex-direction: column; }\n    .users .latest .user-title {\n      flex: 0;\n      display: flex;\n      flex-direction: row;\n      flex-wrap: nowrap;\n      align-items: center;\n      border-bottom: 1px solid #0e1626;\n      width: 100%; }\n      .users .latest .user-title h1 {\n        flex: 1; }\n      .users .latest .user-title i {\n        flex: 0;\n        font-size: 16px; }\n    .users .latest .current-users {\n      flex: 2 0 20vh;\n      display: flex;\n      flex-direction: row;\n      flex-wrap: wrap;\n      justify-content: space-between; }\n      .users .latest .current-users .current-user {\n        flex: 1;\n        display: flex;\n        flex-direction: row;\n        align-items: center;\n        margin: 8px; }\n        .users .latest .current-users .current-user img {\n          flex: 1;\n          width: 20%;\n          height: auto; }\n        .users .latest .current-users .current-user h3 {\n          flex: 2; }\n\n.intro {\n  width: 100%;\n  flex: 0;\n  padding-top: 5%;\n  margin-bottom: 20vh;\n  display: flex;\n  flex-direction: column;\n  background: linear-gradient(rgba(20, 20, 20, 0.5), rgba(20, 20, 20, 0.5)), url(\"https://images.unsplash.com/photo-1502920514313-52581002a659?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1047&q=80\");\n  background-size: cover;\n  background-repeat: no-repeat; }\n  .intro .header {\n    width: 60%;\n    height: auto;\n    align-self: center;\n    display: flex;\n    flex-direction: column; }\n    .intro .header .header-text {\n      align-self: center;\n      color: #ccc;\n      font-size: 72px;\n      z-index: 1;\n      font-weight: 800; }\n    .intro .header .header-par {\n      align-self: center;\n      color: #ccc;\n      z-index: 1;\n      font-weight: 800; }\n    .intro .header .scroll {\n      margin: 0;\n      width: 100%;\n      font-size: 10vw;\n      font-family: \"Poppins\", sans-serif;\n      font-weight: 800;\n      color: #F25CA2;\n      /*rgba(130, 159, 217, .1);*/\n      z-index: 1; }\n      .intro .header .scroll span {\n        margin: 0;\n        padding: 0;\n        display: inline-block;\n        width: 7%; }\n\n@media screen and (max-width: 800px) {\n  /* Modal start */\n  /* The Modal (background) */\n  .modal {\n    display: none;\n    /* Hidden by default */\n    position: fixed;\n    /* Stay in place */\n    z-index: 1;\n    /* Sit on top */\n    left: 0;\n    top: 0;\n    width: 100%;\n    /* Full width */\n    height: 100%;\n    /* Full height */\n    overflow: auto;\n    /* Enable scroll if needed */\n    background-color: black;\n    /* Fallback color */\n    background-color: rgba(0, 0, 0, 0.4);\n    /* Black w/ opacity */ }\n  /* Modal Content/Box */\n  .modal-content {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    background-color: green;\n    margin: 15% auto;\n    /* 15% from the top and centered */\n    padding: 20px;\n    border: 1px solid #000;\n    width: 80%;\n    /* Could be more or less, depending on screen size */\n    border-radius: 10px; }\n    .modal-content .fa-exclamation-circle {\n      font-size: 32px;\n      font-weight: bold; }\n  /* The Close Button */\n  .close {\n    align-self: flex-end;\n    color: #aaa;\n    font-size: 28px;\n    font-weight: bold; }\n  .close:hover,\n  .close:focus,\n  .close:active {\n    color: black;\n    text-decoration: none;\n    cursor: pointer; }\n  /* Modal end*/\n  .button {\n    width: 100%;\n    height: auto;\n    text-align: center;\n    line-height: 40px;\n    border-radius: 50%;\n    background-color: #0029FA;\n    color: #FFFFFF;\n    font-size: 24px;\n    border: none;\n    box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.26), 0 2px 10px 0 rgba(0, 0, 0, 0.22);\n    cursor: pointer; }\n    .button:hover {\n      background: #6e90d3;\n      box-shadow: 0 5px 11px 0 rgba(0, 0, 0, 0.28), 0 4px 15px 0 rgba(0, 0, 0, 0.25);\n      border-radius: 5px;\n      width: 20%;\n      transform: translateY(-8%); }\n    .button:active {\n      background: #6e90d3;\n      box-shadow: 0 5px 11px 0 rgba(0, 0, 0, 0.28), 0 4px 15px 0 rgba(0, 0, 0, 0.25);\n      border-radius: 5px;\n      width: 20%;\n      transform: translateY(-8%); }\n  .users {\n    flex: 1;\n    margin-bottom: 5vh;\n    color: #0e1626;\n    display: flex;\n    flex-direction: row;\n    padding: 0 16px;\n    align-items: flex-start; }\n    .users .user-checkin {\n      margin: 16px;\n      padding: 32px;\n      flex: 1;\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      align-content: center;\n      justify-content: center; }\n      .users .user-checkin .checkin-text {\n        flex: 0;\n        width: 100%;\n        align-self: center; }\n      .users .user-checkin .users-checkin-btn {\n        flex: 1;\n        width: 20%;\n        perspective: 0px;\n        transform-style: preserve-3d;\n        transform-origin: center;\n        display: grid;\n        grid-template-columns: 1fr 3fr 1fr;\n        grid-template-rows: 100%; }\n        .users .user-checkin .users-checkin-btn .front {\n          justify-self: center;\n          grid-column: 2/3;\n          grid-row: 1;\n          z-index: 2;\n          /* for firefox 31 */\n          transform: rotateY(0deg);\n          transform-origin: center;\n          backface-visibility: hidden;\n          background-color: #230A59; }\n        .users .user-checkin .users-checkin-btn .back {\n          justify-self: center;\n          grid-column: 2/3;\n          grid-row: 1;\n          transform: rotateY(180deg);\n          transform-origin: center;\n          backface-visibility: hidden;\n          background-color: #F25CA2; }\n    .users .latest {\n      margin: 16px;\n      padding: 24px;\n      flex: 1;\n      display: flex;\n      flex-direction: column; }\n      .users .latest .user-title {\n        flex: 0;\n        display: flex;\n        flex-direction: row;\n        flex-wrap: nowrap;\n        margin-bottom: 4px;\n        align-items: center;\n        border-bottom: 1px solid #0e1626;\n        width: 100%; }\n        .users .latest .user-title h1 {\n          flex: 1; }\n        .users .latest .user-title i {\n          flex: 0;\n          font-size: 16px; }\n      .users .latest .current-users {\n        flex: 1 0 20vh;\n        display: flex;\n        flex-direction: row;\n        flex-wrap: wrap; }\n        .users .latest .current-users .current-user {\n          flex: 1;\n          display: flex;\n          flex-direction: column;\n          align-items: center;\n          margin: 2px;\n          width: 100%; }\n          .users .latest .current-users .current-user img {\n            flex: 1;\n            width: 40%;\n            height: auto; }\n          .users .latest .current-users .current-user h3 {\n            flex: 2; }\n        .users .latest .current-users .sm-card {\n          box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n          /* this adds the \"card\" effect */\n          padding: 0;\n          text-align: center;\n          background-color: #f1f1f1;\n          border-radius: 8px;\n          width: 70%;\n          height: 50%; } }\n\n@media screen and (max-width: 700px) {\n  .button {\n    width: 100%;\n    height: auto;\n    text-align: center;\n    line-height: 40px;\n    border-radius: 50%;\n    background-color: #0029FA;\n    color: #FFFFFF;\n    font-size: 24px;\n    border: none;\n    box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.26), 0 2px 10px 0 rgba(0, 0, 0, 0.22);\n    cursor: pointer; }\n    .button:hover {\n      background: #6e90d3;\n      box-shadow: 0 5px 11px 0 rgba(0, 0, 0, 0.28), 0 4px 15px 0 rgba(0, 0, 0, 0.25);\n      border-radius: 5px;\n      width: 20%;\n      transform: translateY(-8%); }\n    .button:active {\n      background: #6e90d3;\n      box-shadow: 0 5px 11px 0 rgba(0, 0, 0, 0.28), 0 4px 15px 0 rgba(0, 0, 0, 0.25);\n      border-radius: 5px;\n      width: 20%;\n      transform: translateY(-8%); }\n  .users {\n    flex: 1;\n    margin-bottom: 5vh;\n    color: #0e1626;\n    display: flex;\n    flex-direction: column;\n    align-items: center; }\n    .users .user-checkin {\n      margin: 16px;\n      padding: 32px;\n      flex: 1;\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      align-content: center;\n      justify-content: center; }\n      .users .user-checkin .checkin-text {\n        flex: 0;\n        width: 100%;\n        align-self: center; }\n      .users .user-checkin .users-checkin-btn {\n        flex: 1;\n        width: 20%;\n        perspective: 0px;\n        transform-style: preserve-3d;\n        transform-origin: center;\n        display: grid;\n        grid-template-columns: 1fr 3fr 1fr;\n        grid-template-rows: 100%; }\n        .users .user-checkin .users-checkin-btn .front {\n          justify-self: center;\n          grid-column: 2/3;\n          grid-row: 1;\n          z-index: 2;\n          /* for firefox 31 */\n          transform: rotateY(0deg);\n          transform-origin: center;\n          backface-visibility: hidden;\n          background-color: #230A59; }\n        .users .user-checkin .users-checkin-btn .back {\n          justify-self: center;\n          grid-column: 2/3;\n          grid-row: 1;\n          transform: rotateY(180deg);\n          transform-origin: center;\n          backface-visibility: hidden;\n          background-color: #F25CA2; }\n    .users .latest {\n      margin: 16px;\n      padding: 24px;\n      flex: 1;\n      display: flex;\n      flex-direction: column; }\n      .users .latest .user-title {\n        flex: 0;\n        display: flex;\n        flex-direction: row;\n        flex-wrap: nowrap;\n        margin-bottom: 4px;\n        align-items: center;\n        border-bottom: 1px solid #0e1626;\n        width: 100%; }\n        .users .latest .user-title h1 {\n          flex: 1; }\n        .users .latest .user-title i {\n          flex: 0;\n          font-size: 16px; }\n      .users .latest .current-users {\n        flex: 1 0 20vh;\n        display: flex;\n        flex-direction: row;\n        flex-wrap: wrap; }\n        .users .latest .current-users .current-user {\n          flex: 1;\n          display: flex;\n          flex-direction: column;\n          align-items: center;\n          margin: 2px;\n          width: 100%; }\n          .users .latest .current-users .current-user img {\n            flex: 1;\n            width: 40%;\n            height: auto; }\n          .users .latest .current-users .current-user h3 {\n            flex: 2; }\n        .users .latest .current-users .sm-card {\n          box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n          /* this adds the \"card\" effect */\n          padding: 0;\n          text-align: center;\n          background-color: #f1f1f1;\n          border-radius: 8px;\n          width: 70%;\n          height: 50%; } }\n", ""]);
...
module.exports = __webpack_require__.p + "/images/yatch.svg";

/***/ }),

/***/ "./src/js/scrollAnima.js":
/*!*******************************!*\
  !*** ./src/js/scrollAnima.js ***!
  \*******************************/
/*! no static exports found */
...
__webpack_require__(/*! ../img/yatch.svg */ "./src/img/yatch.svg");
...
var checkIn = document.querySelector(".users-checkin-btn");

var tl = new _gsap.TimelineMax({ repeat: -1, paused: true });
var btn = new _gsap.TimelineMax({ repeat: -1, repeatDelay: 3, paused: true });
var pulse = new _gsap.TimelineMax({ repeat: -1, repeatDelay: 1, paused: true });

tl.set(letter, { opacity: 0 }).staggerTo(letter, 1, { y: 200, opacity: 1, yoyo: true, repeat: 1, ease: _gsap.Power4.easeIn }, 0.2);

btn.to(checkIn, .4, { rotationY: 180, ease: _gsap.Power2.easeIn }).to(".users-checkin-btn", .4, { rotationY: 0, ease: _gsap.Power2.easeIn }, "+=3");
