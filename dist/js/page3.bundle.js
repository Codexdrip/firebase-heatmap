...
var s = document.getElementById("S"); // Also works with TweenLite and TimelineLite
...
var btn = new _gsap.TimelineMax({ repeat: -1, paused: true });
// tl2
//   .to(ship, 10, {
//     bezier: {
//       curviness: 1.21,
...
btn.to(checkIn, .8, { rotation: -25, ease: _gsap.Power2.ease }).to(checkIn, .8, { rotation: 35, ease: _gsap.Power2.ease });
